...
export const routes: Routes = [
  ...
  { path: 'forum', component: Dashboard2Component}, // Pas de garde pour la page de login
  ...
  { path: '', redirectTo: '/accueil', pathMatch: 'full' },  // Redirection vers la page d'accueil pour toutes les autres routes inconnues
];
